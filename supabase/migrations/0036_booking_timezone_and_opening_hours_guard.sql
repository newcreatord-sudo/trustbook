...
-- Add canonical business timezone and enforce opening-hours guardrails.
...
alter table public.businesses
drop constraint if exists businesses_timezone_valid;

alter table public.businesses
add constraint businesses_timezone_valid
...
begin
  ...
  if exists (
    ...
    where business_id = p_business_id
      and status in ('requested', 'pending_approval', 'pending_deposit', 'confirmed', 'change_proposed', 'completed', 'no_show', 'late_cancel')
